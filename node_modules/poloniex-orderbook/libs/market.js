...
class Market {
  ...
  get ask() {
    return parseFloat(this.orderList[0][0][0]);
  }

  get bid() {
    return parseFloat(this.orderList[1][0][0]);
  }

  get midpoint() {
  return ((parseFloat(this.orderList[0][0][0]) + parseFloat(this.orderList[1][0][0])) / 2 )
  }

  get spread() {
    return (parseFloat(this.orderList[0][0][0]) - parseFloat(this.orderList[1][0][0]))
  }
